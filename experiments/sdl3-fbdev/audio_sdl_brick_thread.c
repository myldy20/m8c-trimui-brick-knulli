// Brick-specific SDL3 audio route for the fbdev experiment.
// A dedicated pump thread drains the M8 recording stream and feeds the playback
// stream. This avoids doing playback-stream work while SDL holds the recording
// callback lock, which caused eventual ALSA capture overruns on Knulli.
