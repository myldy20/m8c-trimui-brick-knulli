...
BUILD_DIR="${BUILD_DIR:-/tmp/m8c-fbdev-fast-r5-build}"
...
input_mode=gamepad-plus-face-keyboard
face_key_aliases=A-S-X-Z
controls_default=A-option,B-edit,Select-shift,Start-play
...
grep -a -q 'Brick Select+Y exit combination received' "$APP_DIR/m8c-bin"
