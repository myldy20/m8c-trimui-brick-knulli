...
BUILD_DIR="${BUILD_DIR:-/tmp/m8c-fbdev-fast-r6-build}"
...
python3 /work/experiments/sdl3-fbdev/patch-r6-input-diagnostics.py m8c

cd m8c
make CFLAGS="-DBRICK_GAMEPAD_ONLY -DBRICK_INPUT_DIAGNOSTICS" -j"$(nproc)"
cd "$BUILD_DIR"
...
callback_rate_hz=60
input_mode=diagnostic-gamepad-keyboard-joystick
input_log_marker=INPUTDIAG
...
grep -a -q 'INPUTDIAG' "$APP_DIR/m8c-bin"
