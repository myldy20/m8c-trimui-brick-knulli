...
BUILD_DIR="${BUILD_DIR:-/tmp/m8c-fbdev-fast-r7-build}"
...
controls=A-play,B-shift,X-edit,Y-option,Select-shift,Start-play
exit_combination=select-plus-l2
ignored_controls=L1,R1,R2,volume-minus,volume-plus
...
grep -a -q 'Brick Select+L2 exit combination received' "$APP_DIR/m8c-bin"
